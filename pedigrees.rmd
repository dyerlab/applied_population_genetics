...
- **Consanguaneous mating** (*lit.* "Of the same blood").  The condition where individuals who are related produce offspring.
- **Biparental Inbreeding** (see consanguaneous mating).
...
Perhaps the most studied pedigree is that of the Hapsburg Dynasy, dating from 1516-1700, which controlled most of what we call modern Eurpope.  Some of the European Royalty were interbred to maintain familial relationships and consolidate power.  Examples include:

King                   | Queen                        |  Consanguaneous Marriage
-----------------------|------------------------------|----------------------------
Philip I (1478-1506)   | Joanna I of Castile & Aragon | Third cousins 
Charles I (1500-1558)  | Isabella of Prtugal          | First cousins
Philip II (1527-1598)  | Mary of Portugal             | Double first cousins
$\;$                   | Mary I of England            | First cousins once removed
$\;$                   | Anna of Austria              | Uncle-neice
...
$\;$                   | Mariana of Austria           | Uncle-neice
Charles II (1661-1700) | Marie Louise d'Orleans       | Second cousins




![Hapbsburg Dynasty | Piliip I ($F=0.025$) $\to$ Charles II ($F=0.254$)](media/HapsburgPedigree.png)
...
1. Pituitary homromone deficiency  
...
6. Traits can be mapped onto the pedigree using additonal colors & symbols
