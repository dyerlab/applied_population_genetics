...
# Applied Marker Genetics {- .white_letters}

```{r echo=FALSE, out.width="33%"}
knitr::include_graphics("./media/TitlePage_small.png")
```
...
Dyer RJ.  2016.  Applied Marker Genetics. Perdedor Publishing.  <!-- `XXX`pgs. -->
