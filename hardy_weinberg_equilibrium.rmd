# Hardy-Weinberg Equilbrium {.imageChapter}
...
Punnet squares are a basic tool to understand the probability of offspring genotypes for individual diploid mating events.  

A Punnet square is a simple tool used to teach transition probabilities in basic genetics and biology courses.  Here is an example using the 2-allele example provided in the text to iterate through all the potential mating combinations.

Mating among the same homozygotes uniform offspring genotypes
...
Mating among different homozygotes produces all heterozygotes.
...
Mating among one homozygote and one heterozygote produces 50% homozygotes and 50% heterozygotes
...
Mating among two heterozygote genotypes produces the full array of offspring genotypes in a 1:2:1 ratio.
...
```{r echo=FALSE}
knitr::include_app("https://rodney.shinyapps.io/hardy_weinberg/", height="700")
```
